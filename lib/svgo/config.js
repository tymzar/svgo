...
const validatePluginsMap = require('../../pluginsValidate/pluginsValidate.js');
...
const validatePluginsOrder = ['isArtBoardCorrect', 'isSnakeCase'];

const defaultPlugins = pluginsOrder.filter((name) => pluginsMap[name].active);
exports.defaultPlugins = defaultPlugins;

const defaultValidatePlugins = validatePluginsOrder.filter(
  (name) => validatePluginsMap[name].active
);
exports.defaultValidatePlugins = defaultValidatePlugins;
...
exports.resolveValidatePluginConfig = resolveValidatePluginConfig;
